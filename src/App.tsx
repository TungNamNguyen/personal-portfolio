        ...
        <section className="space-y-8">
          <div className="space-y-4 max-w-3xl">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              An overview of my core technical strengths. I specialize in architecting end-to-end data solutions with a focus on scalability, reliability, and performance.
            </p>
          </div>
          <Skills />
        </section>
